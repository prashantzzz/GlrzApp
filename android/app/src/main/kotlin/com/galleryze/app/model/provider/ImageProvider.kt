...
import com.galleryze.app.metadata.Metadata.TYPE_EXIF
import com.galleryze.app.metadata.Metadata.TYPE_IPTC
import com.galleryze.app.metadata.Metadata.TYPE_MP4
import com.galleryze.app.metadata.Metadata.TYPE_XMP
import com.galleryze.app.metadata.Mp4ParserHelper
import com.galleryze.app.metadata.Mp4ParserHelper.updateLocation
import com.galleryze.app.metadata.Mp4ParserHelper.updateRotation
import com.galleryze.app.metadata.Mp4ParserHelper.updateXmp
import com.galleryze.app.metadata.MultiPage
import com.galleryze.app.metadata.PixyMetaHelper
import com.galleryze.app.metadata.PixyMetaHelper.extendedXmpDocString
import com.galleryze.app.metadata.PixyMetaHelper.xmpDocString
...
import com.galleryze.app.model.ExifOrientationOp
import com.galleryze.app.model.FieldMap
import com.galleryze.app.model.NameConflictResolution
...
import com.galleryze.app.utils.BmpWriter
import com.galleryze.app.utils.FileUtils.transferFrom
import com.galleryze.app.utils.FileUtils.transferTo
import com.galleryze.app.utils.LogUtils
import com.galleryze.app.utils.MimeTypes
import com.galleryze.app.utils.MimeTypes.canEditExif
import com.galleryze.app.utils.MimeTypes.canEditIptc
import com.galleryze.app.utils.MimeTypes.canEditXmp
import com.galleryze.app.utils.MimeTypes.canReadWithExifInterface
import com.galleryze.app.utils.MimeTypes.canRemoveMetadata
import com.galleryze.app.utils.MimeTypes.extensionFor
